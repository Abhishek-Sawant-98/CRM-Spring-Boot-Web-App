...
<head>
	...
	<title>Customer Relationship Management - New Lead Entry Successful</title>
</head>
<body>
	
	<div class="center">
		<img alt="Lead Entry Successful" src="https://i.pinimg.com/564x/ca/93/68/ca9368ef147aff0510e7d666a6d526a3.jpg" />
		<h1 class="text-center font-white">THANK YOU!</h1><br><br><br>
		<h3 class="text-center font-white"> Your new lead details have been saved successfully :)</h3>
