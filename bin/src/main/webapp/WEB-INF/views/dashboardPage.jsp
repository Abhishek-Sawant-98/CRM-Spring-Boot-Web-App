...
<title>Customer Relationship Management - Dashboard</title>
</head>
<body>
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown"><a
							...
							id="leadsDropdownMenuLink" role="button"
						...
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="#"
							id="accountsDropdownMenuLink" role="button"
							...
							<ul class="dropdown-menu"
								...
								<li><a class="dropdown-item" href="#">Recent records</a></li>
							</ul></li>

						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="#"
							id="contactsDropdownMenuLink" role="button"
						...
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="#"
							id="opportunitiesDropdownMenuLink" role="button"
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="accountsDropdownMenuLink">
								...
								<li><a class="dropdown-item" href="/CRM/all-tasks">All Tasks</a></li>
							</ul></li>
						...
						<li class="nav-item">
						<li class="nav-item"><a href="/CRM/logout"
							class="btn btn-primary btn-lg active" role="button"
							aria-pressed="true">Log Out</a></li>
					...
					<div class="modal-body">
						<form:form action="/CRM/dashboard/new-account" method="post" modelAttribute="account" class="row g-3">
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" onclick="populateShippingAddress()" id="sameAddress" /> 
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form:form action="/CRM/dashboard/new-contact" method="post" modelAttribute="contact" class="row g-3">
							...
							<div class="col-md-8">
								<label class="form-label" for="reportsTo"><spring:message code="label.reportsTo" /></label> 
								<form:input path="reportsTo" class="form-control" id="reportsTo" />
								<form:errors path="reportsTo" cssClass="red-font" />
							</div>
