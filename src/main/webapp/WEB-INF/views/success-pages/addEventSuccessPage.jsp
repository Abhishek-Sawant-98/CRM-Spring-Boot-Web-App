...
<head>
	...
	<title>CRM - New Event Entry Successful</title>
</head>
<body>
	
	<header>
		<h2>Your 'New Event' details successfully saved :)</h2>
	</header>
	...
	<nav>
		...
		<a href="/CRM/calendar-page">Back to Calendar Page</a>
		<a href="/CRM/logout">
	...
	<div>
		<img alt="Event Entry Successful" src="https://i.pinimg.com/564x/ca/93/68/ca9368ef147aff0510e7d666a6d526a3.jpg" /><br>
